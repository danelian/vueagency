...
<template>
  <section class="home-howwework">
    <div class="container">
      <div class="home-howwework__container">
        <div class="home-howwework__left">
          <div class="heading">
            <h2 class="title-h2">How we work</h2>
  ...
  &-item {
    ...
    &__icon {
      ...
      &::after {
        ...
        width: 48px;
        height: 48px;
        background-image: url('/public/icons/point.svg');
